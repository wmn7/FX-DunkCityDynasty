'''
@Author: WANG Maonan
@Date: 2023-10-29 14:21:09
@Description: wrapper for ray env
@LastEditTime: 2023-10-29 16:09:41
'''
import numpy as np
import gymnasium as gym
from PlayerAgent.utils.features import onehot
...
class RayWrapper:
    ...
    def states_wrapper(self, state_infos):
        states, infos = {}, {}
        for key in state_infos.keys(): # key 是不同的球员
    ...
    def handle_agent_states(self, agent_states_dict):
        agent_states_list = []
        agent_states_list.append(agent_states_dict['character_id']) # character id
